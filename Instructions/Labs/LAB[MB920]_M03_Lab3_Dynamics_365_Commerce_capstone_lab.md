...
ms.locfileid: "137909282"
---
## <a name="lab-3---dynamics-365-commerce-capstone-lab"></a>实验室 3 - Dynamics 365 Commerce 顶点实验室
...
## <a name="exercise-1-explore-commerce-headquarters"></a>练习 1：探索 Commerce Headquarters

### <a name="create-a-new-store"></a>创建新商店
...
### <a name="add-a-group-of-products-to-an-assortment-and-publish"></a>将一组产品添加到分类并发布
...
### <a name="run-the-retail-scheduler-job-for-products"></a>运行产品的零售计划程序作业
...
### <a name="create-a-new-product-discount"></a>创建新的产品折扣
