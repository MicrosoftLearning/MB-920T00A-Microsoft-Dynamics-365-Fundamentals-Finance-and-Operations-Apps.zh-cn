...
ms.locfileid: "137909587"
---
## <a name="lab-8---dynamics-365-supply-chain-management-capstone-lab"></a>实验室 8 - Dynamics 365 Supply Chain Management 顶点实验室
...
## <a name="exercise-1-explore-product-management"></a>练习 1：探索产品管理
...
## <a name="exercise-2-explore-warehouse-management"></a>练习 2：探索仓库管理

### <a name="create-a-warehouse"></a>创建仓库

1. 使用导航窗格选择“模块” > “库存管理” > “设置” > “库存细分” > “仓库”。    

1. 在“仓库”页的“操作”菜单中，选择“新建”。
...
### <a name="create-a-trade-agreement-for-sales-price"></a>创建销售价格贸易协议
...
## <a name="exercise-3-explore-production-management"></a>练习 3：探索生产管理

### <a name="create-a-production-order-for-a-product"></a>创建产品的生产订单
...
## <a name="exercise-4-explore-inventory-management"></a>练习 4：探索库存管理

### <a name="create-a-count-journal-with-the-product-for-the-created-warehouse"></a>为创建的仓库创建产品的盘点日记帐
...
### <a name="check-on-hand-inventory-for-the-product"></a>检查该产品的现有库存
...
## <a name="exercise-5-explore-procurement-and-sourcing"></a>练习 5：探索采购

### <a name="create-a-purchase-order-with-a-product"></a>创建产品的采购订单
